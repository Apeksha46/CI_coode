...
abstract class REST_Controller extends CI_Controller {
    ...
    protected function _userLoginCheck( $token )
    {
        ...
        $user = $this->CommonModel->selectRowDataByCondition( $token , 'customer');
        // print_r($user);exit;
    ...
    protected function _driverLoginCheck( $token )
    {
        if( $token == '' )
        {     
        ...
        $this->load->model( 'CommonModel' );
        $user = $this->CommonModel->selectRowDataByCondition( $token , 'delivery_man');
        // print_r($user);exit;
    ...
    protected function _sendiOSNotification( $values )
    {
        ...
        $this->notification->insert( $ntfctn );

        if ( ENVIRONMENT === 'production' ) {
            $gateway = 'ssl://gateway.push.apple.com:2195';
            $pem = IOS_PEM . 'Speed-Shopper_Prod.pem';
        } else { 
            $gateway = 'ssl://gateway.sandbox.push.apple.com:2195';
            $pem = IOS_PEM . 'Speed-Shopper_Dev.pem';
        }
