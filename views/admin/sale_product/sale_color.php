<div id="page-wrapper">
	<div class="header">
		<ol class="breadcrumb">
            ...
            <li style="float: right"><a class="btn btn-primary" href="<?php echo site_url('seller/Sale_Product/sale_addColorSize');?>">Add Color</a></li>
		</ol> 			
	</div>
    <!-- /. PAGE INNER  -->
    <div id="page-inner">
                                    ...
                                    <?php
                                        ...
                                        foreach ($colorData as $key) { 
                                            ...
                                            <tr class="gradeC">
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-sm btn-primary mb-2" href="<?php echo site_url('seller/Sale_Product/sale_editColorSize/'.$key["color_id"]);?>">Edit</a>
...
<script type="text/javascript">
    ...
    function deleteColor(color_id){
        if (confirm('Are you sure you want to delete this?')) {
            $.ajax({
                url: '<?php echo site_url("seller/Sale_Product/delete_color"); ?>',
                type: "POST",
                data: {
                    "color_id" : color_id
                },
