            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <div id="msg"></div>
                        <form class="" action="<?php echo site_url('seller/Sale_Product/manage_stock');?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit"  name="manage" class="btn btn-primary">Add Now</button>
                            </div>
                        </form>
                    </div>
                </div>
