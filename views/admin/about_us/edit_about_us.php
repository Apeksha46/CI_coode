                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="card-title">
                            <div class="title">Edit About Us Content</div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form class="form-horizontal" action="<?php echo site_url('admin/About_us/update_about_us');?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" name="about_us_id" value="<?php if (!empty($tableData[0]['about_us_id'])) { echo $tableData[0]['about_us_id']; } ?>">
