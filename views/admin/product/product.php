<div id="page-wrapper">
	<div class="header">
		<ol class="breadcrumb">
            ...
            <li style="float: right"><a class="btn btn-primary" href="<?php echo site_url('admin/Product/add_product');?>">Add Product</a></li>
		</ol> 			
	</div>
    <!-- /. PAGE INNER  -->
    <div id="page-inner">
                                    ...
                                    <?php
                                        ...
                                        foreach ($tableData as $key) { 
                                            ...
                                            <tr class="gradeC">
                                                ...
                                                <td class="center">
                                                    <a class="btn btn-primary" href="<?php echo site_url('admin/Product/edit_Product/'.$key["product_id"]);?>">Edit</a>
...
<script type="text/javascript">
    ...
    function delteFunction(val){
        if (confirm('Are you sure you want to delete this?')) {
            $.ajax({
                url: '<?php echo site_url("admin/Product/delete_Product"); ?>',
                type: "POST",
                data: {
                    "product_id" : val
                },
