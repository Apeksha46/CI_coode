            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <div id="msg"></div>
                        <form class="" action="<?php echo site_url('seller/Product/update_manage_stock');?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group" id="sizeDiv">
                                    ...
                                    <div class="pr-size input_size_fields_wrap">
                                        <div class="row"> 
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control"  placeholder="Enter Quantity" name="qty[]" id="xs_qty" >
                                            </div>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" name="manage" class="btn btn-primary">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function deleteSizes(size_id){
        if (confirm('Are you sure you want to delete this?')) {
            $.ajax({
                url: '<?php echo site_url("seller/Product/delete_size"); ?>',
                type: "POST",
                data: {
                    "sizes_id" : size_id
                },
