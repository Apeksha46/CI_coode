            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form class="form-horizontal" action="<?php echo site_url('admin/SubCategory/insert_sub_category');?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input required="" type="text" name="sub_category_name" class="form-control" id="inputEmail3" placeholder="Sub-Category Name">
                                </div>
                            </div>
                            <div class="form-group">
