            ...
            <div class="col-xs-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form class="" action="<?php echo site_url('admin/Plan/update_plan');?>" enctype="multipart/form-data" method="post">

                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                <label for="inputEmail3" class="control-label">Plan</label>
                                    <input type="hidden" name="plan_id" value="<?php echo $tableData->plan_id; ?>">
                                    <input type="text" name="plan_name" class="form-control" id="inputEmail3" required="" placeholder="Plan Name" value="<?php echo $tableData->plan_name; ?>">
                            </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
