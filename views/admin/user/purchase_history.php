...
<script type="text/javascript">
    ...
    function filterData(){
        ...
        var customer_id = '<?php echo $this->uri->segment(4); ?>';
        $.ajax({
            url: '<?php echo site_url("admin/User/filter_purchase_history"); ?>',
            type: "POST",
            data: {
            ...
            success: function (response) {
                if (response == '0') {
                    ...
                    for(var i=0; i<obj.length; i++){
                        ...
                        var payment_mode    = '';
                        var payment_status  = '';
                        var seller_name     = obj[i]['seller_first_name']+' '+obj[i]['seller_last_name'];
