<div id="page-wrapper">
	<div class="header">
		<ol class="breadcrumb">
			...
			<li class="active">Add Web Slider</li>
            <li></li>
		</ol> 			
	</div>
    <!-- /. PAGE INNER  -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="card-title">
                            <div class="title">Add Web Slider Content</div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form class="form-horizontal" action="<?php echo site_url('admin/Web_Slider/insert_slider');?>" enctype="multipart/form-data" method="post">
                             <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Slider Name</label>
                                <div class="col-sm-10">
                                   <!--  <textarea class="form-control" rows="3" name="slider_desc" required="" placeholder="Slider Description"></textarea> -->
                                   <!-- <input type="text" name="slider_title" placeholder="Slider Name"> -->
                                   <input type="text" name="slider_title" class="form-control" id="inputEmail3" placeholder="Slider Name">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Slider Name</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <img id="preview" src="<?php echo base_url().'slider/blogpost-placeholder-100x100.png' ?>" alt="your image" width="150px" height="120px" />
                                </div>
                            </div>
                            <div class="form-group">
