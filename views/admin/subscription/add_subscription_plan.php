<div id="page-wrapper">
	<div class="header">
		<ol class="breadcrumb">
			...
			<li class="active">Add Subscription Plan</li>
            <li></li>
		</ol> 			
	</div>
    <!-- /. PAGE INNER  -->
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="card-title">
                            <div class="title">Add Subscription Plan</div>
                        </div>
                    </div>
                    <div class="panel-body">
                        ...
                        <?php } ?>
                        <form class="" action="<?php echo site_url('admin/Subscription_Plan/insert_subscription_plan');?>" enctype="multipart/form-data" method="post">
                            ...
                            <div class="row">
                                ...
                                <label for="inputEmail3" class="control-label">Subscription Plan</label>
                                    <input type="text" name="plan_name" class="form-control" id="inputEmail3" required="" placeholder="Subscription Plan Name">
                            </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <label for="inputEmail3" class="control-label">Gst Tax</label>
                                    <input type="text" name="gstTax" class="form-control" onkeypress="return isNumberKey(event)" id="inputEmail3" required="" placeholder="Gst Tax">
                            </div>
                                </div>
                            </div>
