...
.grid {
  ...
  max-width: 320px;
  max-width: 21rem;
  width: 90%;background: rgba(255,255,255,.8);
  padding: 10px;
}
...
input#seller_email:-internal-autofill-selected{
  background: red;
}
...
<body class="align">
  ...
  <div class="grid">
    ...
    <?php } ?>
    <form action="<?php echo site_url('seller/Auth/send_mail');?>" method="POST" class="form login">

      <a class="img-brand" href="<?php echo site_url('seller/Auth/'); ?>"><img src="<?php echo base_url('assets/img/logo.png'); ?>" class="img-responsive"></a>
