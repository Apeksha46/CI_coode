            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6 ">
                    <ol class="breadcrumb float-sm-right">
                        <a href="{{ route('framework.index') }}" class="btn ipfs-button"><i
                ...
                <div class="col-12">
                    <div class="card table-responsive">
                        <div class="card-header">
                            <h3 class="card-title">Add Framework</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">

                            <form action="{{ route('framework.store') }}" method="post" data-parsley-validate="">
                                @csrf
