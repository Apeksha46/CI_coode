                  ...
                  <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="recent-activity form-ui">
                           <p> <i class="ti-user"></i>&nbsp; Personal Details</p>
                            <form action="<?php echo base_url('website/Auth/update_profile'); ?>" method="post" enctype="multipart/form-data">
                              <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="recent-activity form-ui">
                           ...
                           <form action="<?php echo base_url('website/Auth/reset_password'); ?>" method="post">
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
