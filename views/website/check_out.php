...
<section class="find-normal-section  m-5">
    <div class="container-fluid">
        <div class="checkout-area ">
            <form method="Post" action="<?php echo site_url('website/CheckOut/proceed');?>" id="demo-form" data-parsley-validate="">
                    ...
                    <div class="col-lg-6 col-md-6">
                       <div class="your-order">
                          ...
                          <form class="form-ui form-group">
                             ...
                             <div>
                               <input type="checkbox" name="term" id="chkterms" value="1"><a href="<?php echo site_url();?>website/Auth/term_and_condition"> I accept term & Condition </a> 
                               <br/>
                               <?php
                               ...
                               // print_r();exit;
                                ...
                                <?php }else{ ?>
			                            <div class="form-group ">
			                                <a class="btn  btn-block" class="nav-link" href="<?php echo base_url(); ?>website/Auth/login" >Proceed</a>
			                            </div>
                                <?php }
                               ?>
                             </div>
...
<script type="text/javascript">
  ...
  $(document).ready(
    function getInfo() {
      ...
      if (valueOfSession != '') 
      {
        ...
        $.ajax({
          url: '<?php echo site_url("website/CheckOut/getInfo"); ?>',
          type: "POST",
          data: {
  ...
  $(document).ready(function getState(country_id){
      $.ajax({
          url: '<?php echo site_url("website/CheckOut/getState"); ?>',
          type: "POST",
          data: {
              "country_id" : 101
          },
  ...
  {
      $.ajax({
          url: '<?php echo site_url("website/CheckOut/getCity"); ?>',
          type: "POST",
          data: {
              "state_id" : state_id
          },
