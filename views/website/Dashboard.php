      ...
      <div class="col-md-3 col-sm-6">
            <div class="product-grid5">
               ...
               <div class="product-content">
                  ...
                  <?php }else{ ?>
                     <button type="button" data-toggle="modal" data-target="#myModal" class="btn">Add to cart</button>
                  <?php } ?>
               </div>
            </div>
      </div>
...
<script type="text/javascript">
   ...
   function checkWonStatus()
   {
      ...
      if (id != '') {
        $.ajax({
           url: '<?php echo site_url("website/Auth/checkWonStatus"); ?>',
           type: "POST",
           data: {
               "id" : id
           },
   ...
   function wonStatusChange()
   {
      ...
      // alert(id);
      $.ajax({
         url: '<?php echo site_url("website/Auth/wonStatusChange"); ?>',
         type: "POST",
         data: {
             "id" : id
         },
