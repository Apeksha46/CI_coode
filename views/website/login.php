...
<html lang="en">
   ...
   <body>
      ...
      <div class="bg">
         <form class="registration form-ui color-input-fild mt-4" method="post" action="<?php echo base_url(); ?>website/Auth/signin">
               ...
               <div class="row">
                  <div class=" col-md-10">
                                 <div class="d-flex justify-content-start links text-drak">
                                    Don't have an account? <a href="<?php echo base_url(); ?>website/Auth/signup" class="ml-2  text-drak">Sign Up</a>
                                 </div>
                                 <div class="d-flex justify-content-start links text-drak">
                                    Are you Forget Password ?<a href="<?php echo base_url(); ?>website/Auth/forget_password" class="ml-2  text-drak">Forget Password</a>
                                 </div>
                              </div>
