...
<html lang="en">
   ...
   <body>
      ...
      <div class="bg">
         <form class="registration form-ui mt-4 color-input-fild" method="post" action="<?php echo site_url(); ?>website/Auth/chainSignUp">
            ...
            ?>
               <div class="row">
                <div class="col-md-12 text-center"> 
                  <a href="<?php echo base_url(); ?>website/Auth/login" class="ml-2  text-drak">Login</a>
                  <h2>Sign Up</h2>
                </div>
                  <div class="col-md-6">
