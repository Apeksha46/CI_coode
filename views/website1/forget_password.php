...
<html lang="en">
   ...
   <body>
      ...
      <div class="bg">
         <form class="registration form-ui mt-4" method="post" action="<?php echo base_url(); ?>website1/Auth/send_mail">
               ...
               <div class="row">
                  <div class=" col-md-6">
                     <div class="d-flex justify-content-start links text-drak">
                        If you have an account  <a href="<?php echo base_url(); ?>website1/Auth/login" class="ml-2  text-drak">Sign In</a>
                     </div>
               </div>
