     ...
     <!--  <section class="newsletter">
            ...
            <div class="row pb-4">
               ...
               <div class="col-md-2 mb-3 text-center">
                  ...
                  <ul class="list-unstyled quick-links">
                     <li><a href="<?php echo base_url().'website1/Auth/about_us';?>"></i>About Us</a></li>
                     <!-- <li><a href="#"></i>Delivery Information</a></li> -->
                     <li><a href="<?php echo base_url().'website1/Auth/privacy_policy';?>"></i>Privacy Policy</a></li>
                     <!-- <li><a href="<?php echo base_url().'website1/Auth/term_and_condition';?>"></i>Terms & Conditions</a></li> -->
      ...
      <!-- <div class="scroll-top-wrapper ">
        <span class="scroll-top-inner">
          <img src="<?php echo base_url(); ?>assets/website1/img/back-top.png">
        </span>
      </div>
      </div> -->

      <!-- jquery plugins here-->
      <!-- <script src="<?php echo base_url(); ?>assets/website1/js/jquery-1.12.1.min.js"></script> -->
      <!-- bootstrap js -->
