     ...
     <section>
      ...
      <tr style="color: #000;">
         <td style="text-align: center; background: rgb(109, 102, 102) none repeat scroll 0% 0%; color: rgb(255, 255, 255); font-size: 22px; font-family: sans-serif;">
            <p>Welcome to Small Bazar</p>
         </td>
      </tr>
   <tr>
      <td style="font-family: sans-serif; width: 100%; padding: 0 2rem; color: #000; font-size: 16PX; text-align: left;">

         <p style="color: #666; font-size: 18px; text-align: left;">Hello, <span style="color: #333;"><?php echo $name; ?></span></p>

        <p style="color: #666; font-size: 18px; text-align: left;">
            This is your referal link, Please share with your friends and get points into your wallet . Your Referal link given below.
        <a class="btn btn-primary" href="<?php echo $link; ?>"><?php echo $link; ?></a></p>
         ...
         <p style="font-size: 14px;"><b>Email:</b> smallbazariim@gmail.com</p>

         <p style="font-size: 14px;"> <a target="_blank" href="<?php echo base_url(); ?>" style="color: rgb(238, 126, 44)">www.smallbazar.in</a></p>
