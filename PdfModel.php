...
class PdfModel extends CI_Model
{
    ...
    {
      $query = 'SELECT  bus.bus_number,chaperone.chaperone_name, driver.driver_name,t.trip_date,t.trip_start,t.trip_end,t.note FROM trip t LEFT JOIN bus ON bus.id = t.bus_id LEFT JOIN chaperone ON chaperone.id = t.driver_id LEFT JOIN  driver ON  driver.id = t.driver_id where t.id in('.$ids.')';
