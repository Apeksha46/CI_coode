...
class CheckOut extends MY_Controller {
	...
	public function index()
	{
        ...
        redirect('website/CheckOut/checkout');
	}
            ...
            if ($book) {
                ...
                // print_r($dataText);
                    ...
                    $this->email
                        ...
                        ->message($this->load->view('email_templates/orderDetail',$dataText,TRUE ))
                        ->set_mailtype('html');
    ...
    public function checkout()
    {
        ...
        $this->load->view('website/check_out',$data);
        $this->load->view('website/common_files/footer');
    }
                ...
                if ($amt1 == 0) {
                    try 
                    {
                        $response = $api->paymentRequestCreate(array(
                            ...
                            "redirect_url" => base_url()."website/CheckOut/thankyou?id=".$lastId,
                    ...
                    redirect("website/CheckOut/thankyou?id=".$lastId);
    ...
    public function count_cart()
    {
        ...
        if (!empty($cart)) {
            foreach ($cart as $key => $value) {
                $checkoutUrl    = base_url().'website/CheckOut/checkout';
                $cartUrl        = base_url().'website/CheckOut/cart_item';
