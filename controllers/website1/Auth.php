...
class Auth extends MY_Controller {
    ...
    public function invite()
    {
        ...
        $this->load->view('website1/invite');
    ...
    public function term_and_condition()
    {
        ...
        $data['arr'] = $arr;
        $this->load->view('website1/term_and_condition', $data);
        $this->load->view('website1/common_files/footer');
    }
    ...
    public function about_us()
    {
        ...
        $data['arr'] = $arr;
        $this->load->view('website1/about-us', $data);
        $this->load->view('website1/common_files/footer');
    }
    ...
    public function index()
    {
        ...
        // print_r($data);die;
        $this->load->view('website1/Dashboard',$data);
        $this->load->view('website1/common_files/footer');
    }
    ...
    public function signup()
    {
        ...
        $this->load->view('website1/signup');
    }
    ...
    public function setting()
    {
        ...
        $this->load->view('website1/common_files/header',$arr);
        $this->load->view('website1/change_password');
        $this->load->view('website1/common_files/footer');
    }
    // update Profile.
    public function update_profile()
    {
        ...
        if (empty($_FILES['file']['name'])) {
            ...
            if (!$this->upload->do_upload('file')) {
                ...
                redirect('website1/Auth/setting');
            }else { 
                $data = array(
                    "first_name"        => $this->input->post('first_name'),
                    "last_name"         => $this->input->post('last_name'),
    ...
    {
         $this->load->view('website1/forget_password');
    }
    ...
    public function send_mail(){
        ...
        {   
            ...
            if ($adminData) {
                ...
                // $mail['message']    = 
                // $this->load->view('email_templates1/forget_password',$data1,TRUE );
                ...
                $this->email
                    ...
                    ->message($this->load->view('email_templates1/forget_password',$data1,TRUE ))
                    ->set_mailtype('html');
    ...
    public function referral_code()
    {
        ...
        redirect('website1/Auth/signup?id='.$referral_code);
        // redirect('website1/Auth/signup');
    }
    ...
    public function myAccount()
    {
        ...
        $this->load->view('website1/myAccount',$aa);
        $this->load->view('website1/common_files/footer');
    }
    ...
    public function share_list()
    {
        ...
        $this->load->view('website1/share_list', $data);
        $this->load->view('website1/common_files/footer');
    }
    ...
    public function topup()
    {
        ...
        try 
        {
            $response = $api->paymentRequestCreate(array(
                ...
                "redirect_url" => base_url()."website1/Auth/topupThankyou?id=".$user_id.'&a='.base64_encode($amount),
    ...
    public function topupThankyou()
    {
        ...
        if ($data) {
            ...
            if ($userUpdate) {
                $this->load->view('email_templates1/topupThankyou');
            }else{
                $this->load->view('email_templates1/fail');
            }
        }
    }
    ...
    public function packagePurchase()
    {
        ...
        try 
        {
            $response = $api->paymentRequestCreate(array(
                ...
                "send_sms" => true,
                'allow_repeated_payments' => false,
                "redirect_url" => base_url()."website1/Auth/packageThankyou?id=".$user_id.'&a='.base64_encode($package_price).'&package_id='.$package_id,
                // "webhook" => "https://studentstutorial.com/instamojo/webhook.php"
                ));
            $pay_ulr = $response['longurl'];
            /*end update producta quantity*/
