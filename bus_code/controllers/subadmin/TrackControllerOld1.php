<?php
    ...
    public function getStatuUser()
    {
    	...
    	$clientuserData = $this->CommonModel->statusUser($bus_id,$driver_id,$status,$chaperone_id,$client_user,$trip_date);
    	...
    	if (!empty($clientuserData))
        {
            ...
            { 
                ...
                // $k = "";
                    ...
                    $date = date("d/m/Y", strtotime($clientuserData[$i]['trip_date']));
