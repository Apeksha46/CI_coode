...
class LocationController extends REST_Controller
{
	...
	public function setLocation_post()
	{
        ...
        if($updateTripLocation)
        {
            ...
            $dataText['trip_id'] 			= $tripData->id;
            $dataText['pickup_address'] 	= $tripData->pickup_address;
            $dataText['pickup_latitude'] 	= $tripData->pickup_latitude;
            $dataText['pickup_longitude'] 	= $tripData->pickup_longitude;
            $dataText['drop_address'] 		= $tripData->drop_address;
            $dataText['drop_latitude'] 		= $tripData->drop_latitude;
            $dataText['drop_longitude'] 	= $tripData->drop_longitude;
			...
			return $this->response(array(
				...
				'message' 	=> 'You update location successfully',
				'object'	=> $dataText
			)); 
        }
        else
