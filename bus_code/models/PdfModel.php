...
class PdfModel extends CI_Model
{
    ...
    {
      $query = 'SELECT  trip_add_parents.note,trip_add_parents.updated_at,parents.parents_name,parents.phone_number FROM trip_add_parents LEFT JOIN parents ON parents.id = trip_add_parents.parents_id where trip_add_parents.id in('.$ids.')';
      $query = $this->db->query($query);
