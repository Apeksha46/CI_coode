               ...
               <div class="">
                <div class="row">
                    <!-- <h4><?= $title?> (<? if(empty($parents_count->parents_total)){ echo 0; }else{ echo $parents_count->parents_total;}?>)</h4> -->
                     ...
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('trip_start'); ?></p> <p class="mb-1"> <?= $tripDetail->trip_start; ?></p></div>
                     <div class="col"> <p class="mb-1"> <?php echo $this->lang->line('trip_end'); ?></p> <p class="mb-1"> <?= $tripDetail->trip_end; ?></p></div>
                     <div class="col"> <p> <?php echo $this->lang->line('note'); ?></p> <p> <?= $tripDetail->note; ?></p></div>
                 </div>
                    <div class="d-flex">
                        
                         <div class="ml-auto">
                              <a class="btn-outline-warning btn btn-sm" href=""  data-toggle="modal" data-target="#importTripParent">
                                <?php echo $this->lang->line('import'); ?> 
                                <i class="fa fa-plus ml-1" aria-hidden="true"></i>
                              </a>
                              <a class="btn-outline-warning btn btn-sm" href="
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="<?php echo base_url().'subadmin/trip_view/'.$tripDetail->tripId;?>" class="btn btn-primary"><?php echo $this->lang->line('ok'); ?></a>
