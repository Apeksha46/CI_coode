...
<nav class="navbar navbar-expand-lg navbar-blue bg-white">
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <?php
        ...
        if($record_num=='parents'||$record_num=='parents_add'||$record_num1=='parents_edit'||$record_num=='import_parents_view'){
...
<?php if($record_num !='how_to' && $record_num !='about_us'  && $record_num !='contactUs') { ?>
