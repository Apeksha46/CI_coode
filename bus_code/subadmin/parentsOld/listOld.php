               ...
               <div class="">
                    ...
                    <div class="d-flex mb-3">
                       ...
                       <button class="btn-sm btn-warning mr-3 bg-transparent border-0" id="btnDelete" onclick="checkValue()">
                        ...
                        <form action="<?php echo site_url()?>subadmin/ParentsController/excelParentsList" method="POST">
                        ...
                        <form action="<?php echo site_url()?>subadmin/ParentsController/pdfParentsList" method="POST">
                           <input type="hidden" name="parentId" class="textIddss" value="">
