...
<nav class="navbar navbar-expand-lg navbar-blue bg-white">
  ...
  <a class="navbar-brand" href="#"><img width="250px" src="<?php echo base_url(); ?>assest/img/logo.png"></a>
            ...
            <div class="col-sm-5">
                ...
                <form class="login-form" action="<?php echo site_url('admin/check_login');?>" method="POST" data-parsley-validate>
                    ...
                    <div class="form-group">
                       <input placeholder="<?php echo $this->lang->line('admin_user_name'); ?>" class="form-control" type="text" name="username" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_name'); ?>">
                       <input placeholder="<?php echo $this->lang->line('admin_user_password'); ?>" class="form-control" type="password" name="password" required data-parsley-required data-parsley-required-message="<?php echo $this->lang->line('enter_admin_user_password'); ?>">
                    </div> 
