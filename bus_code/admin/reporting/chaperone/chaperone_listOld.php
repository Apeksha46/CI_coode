    ...
    <div class="border p-3 bg-white">
        <div class="">
            ...
            <div class="d-flex w-100">
                ...
                <div class="ml-auto">
                   <!--  <a class="btn-outline-warning btn btn-sm waves-effect waves-light" href="" data-toggle="modal" data-target="#importClientUser">
                    ...
                    <a class="btn-outline-warning btn btn-sm waves-effect waves-light" href="<?php echo site_url('admin/reporting/chaperoneAdd');?>">
            ...
            <div class="d-flex mb-3">
                ...
                <form action="<?php echo site_url()?>admin/reporting/ChaperoneController/excelChaperoneList" method="POST">
                ...
                <form action="<?php echo site_url()?>admin/reporting/ChaperoneController/pdfChaperoneList" method="POST">
                   <input type="hidden" name="chaperoneId" class="textIddss" value="">
                ...
                <table class="table table-borderless border-top border-bottom" id="example">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a  title="<?php echo $this->lang->line('edit')?> " href="<?php echo base_url().'admin/reporting/chaperoneEdit/'.$value['chaperone_id'];?>" class="text-warning mr-3" ><?php echo $this->lang->line('edit')?></a>

                                <a  title="<?php echo $this->lang->line('delete'); ?>" class="text-warning mr-3" href="<?php echo base_url().'admin/reporting/ChaperoneController/delete/'.$value['chaperone_id'];?>" onclick="return deleteBus()" ><?php echo $this->lang->line('delete'); ?></a>
                            </td>
                        </tr>
                        <?php $i++; } }?>
