        ...
        <div class="">
            <div class="filter-menu mb-3">
                <ul class="nav">
                  <li class="nav-item">
                    <div class="row">
                         <label class="col-sm-2 mb-0 align-items-center d-flex"><?php echo $this->lang->line('client_name'); ?></label>
                         <div class="col-sm-10">
            ...
            <div class="d-flex w-100">
                ...
                <div class="ml-auto">
                    ...
                    <a class="btn-outline-warning btn btn-sm waves-effect waves-light" href="<?php echo site_url('admin/reporting/busAdd');?>">
            ...
            <div class="d-flex mb-3">
                ...
                <form action="<?php echo site_url()?>admin/reporting/BusController/excelBusList" method="POST">
                ...
                <form action="<?php echo site_url()?>admin/reporting/BusController/pdfBusList" method="POST">
                   <input type="hidden" name="busId" class="textIddss" value="">
