        ...
        <div class="">
            <div class="filter-menu mb-3">
                <ul class="nav">
                  <li class="nav-item">
                    <div class="row">
                         <label class="col-sm-4 mb-0 align-items-center d-flex pr-0"><?php echo $this->lang->line('client_name'); ?></label>
                         <div class="col-sm-8">
            ...
            <div class="d-flex w-100">
                ...
                <div class="ml-auto">
                    ...
                    <a class="btn-outline-warning btn btn-sm" href="<?php echo site_url('admin/reporting/driverAdd');?>">
            ...
            <div class="d-flex mb-3">
                ...
                <form action="<?php echo site_url()?>admin/reporting/DriverController/excelDriverList" method="POST">
                ...
                <form action="<?php echo site_url()?>admin/reporting/DriverController/pdfDriverList" method="POST">
                   <input type="hidden" name="driverId" class="textIddss" value="">
